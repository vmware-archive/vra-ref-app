 ...
 */
function DestroyAction(name, templateApi) {
    this.iconClassName = 'glyphicon-trash';

    Action.call(this, name, templateApi);

    this.message = "Destroy request has been submitted!";
}
DestroyAction.prototype = Object.create(Action.prototype);
